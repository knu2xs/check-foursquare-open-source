.. check-foursquare-open-source documentation master file.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

check-foursquare-open-source Documentation
=============================================================================================================
...
check_foursquare_open_source
================================

Example using the `Sphinx Autodoc`_ extension to document the automatically included support library for this
project located in ``./src/check_foursquare_open_source``.

.. automodule:: check_foursquare_open_source
    :members:

check_foursquare_open_source.utils
-----------------------------------------------------------

These utilities are included by default to speed up the development process.

.. automodule:: check_foursquare_open_source.utils
    :members:
