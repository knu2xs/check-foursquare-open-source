...
if importlib.util.find_spec('check_foursquare_open_source') is None:
    ...
    if not src_dir.exists():
        raise EnvironmentError('Unable to import check_foursquare_open_source.')

    # add the source directory to the paths searched when importing
    sys.path.insert(0, str(src_dir))

# import check_foursquare_open_source
import check_foursquare_open_source
