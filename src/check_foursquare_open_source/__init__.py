__title__ = "check-foursquare-open-source"
__version__ = "0.0.0"
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    .. code-block:: python
        ...
        from check_foursquare_open_source import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        .. code-block:: python
            ...
            from check_foursquare_open_source import ExampleObject
    ...
    def example_class_method(cls):
        ...
        .. code-block:: python
            ...
            from from check_foursquare_open_source import ExampleObject
